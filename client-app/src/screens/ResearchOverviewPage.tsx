...
export function ResearchOverviewPage({ repository = defaultResearchRepository }: { repository?: ReportRepository }) {
  ...
  return <section className="research-page">
    ...
    <section className="research-hero"><h2>今日研究变化</h2><div className="research-metrics"><strong>行业升温 {warming}</strong><strong>行业降温 {cooling}</strong><strong>标的池变化 {watchlist.changes.length}</strong></div></section>
